class Foto {
	...
	drawText() {
        ...
        var croppedWidth = parseInt(parseInt(this.selectRect.style.width.replace(/\D/g,'')) * imgWFactor);
        var croppedHeight = parseInt(parseInt(this.selectRect.style.height.replace(/\D/g,'')) * imageHFactor);
		var textStr = document.getElementById('strtxt').value;
		this.operationEditedCtx.font = '10px serif';
		this.operationEditedCtx.fillText(textStr, croppedWidth, croppedHeight);
        this.operationOrgCtx.fillText(textStr, croppedWidth, croppedHeight);
